...
def upgrade() -> None:
    op.create_table('onboarding_progress',
        ...
        sa.Column('content_reviewed', sa.Boolean(), nullable=False, server_default=sa.text('false')),
        sa.Column('stripe_connected', sa.Boolean(), nullable=False, server_default=sa.text('false')),
